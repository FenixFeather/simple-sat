...
class Generator():
    ...
    def generate(self):
        ...
        return dictionary[self.distribution][0](*dictionary[self.distribution][1])  #Looks up the word, calls the corresponding function with corresponding parameters. '*' unpacks tuple into arguments
